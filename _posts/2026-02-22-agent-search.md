...
- **Reward-chasing can diverge from what you want:**
    - <tip t="OpenAI (2016): the CoastRunners boat racing agent endlessly circled a lagoon for bonus points instead of finishing the race. Reward measured score, not race completion." href="https://openai.com/index/faulty-reward-functions/" link-text="OpenAI: Faulty Reward Functions →">A boat racing agent</tip> circled endlessly for bonus points instead of finishing because the reward prioritized point collection over completing the race.
    - <tip t="DeepMind's canonical collection of ~60 cases where RL agents exploit loopholes in reward specifications" href="https://deepmind.google/blog/specification-gaming-the-flip-side-of-ai-ingenuity/" link-text="DeepMind: Specification Gaming →">DeepMind catalogs</tip> ~60 similar cases.
